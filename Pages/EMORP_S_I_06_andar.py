...
st.set_page_config(layout="wide",initial_sidebar_state="collapsed",page_title="EMORP - INTENSIVA E")
                                ...
                                SELECT
                                  CASE 
                                    WHEN LENGTH(obter_valor_dominio(2088, IE_RASS)) > 21 THEN 
                                      SUBSTR(obter_valor_dominio(2088, IE_RASS), 1, 22) || '...'
                                    ELSE 
...
if __name__ == "__main__":
    try:
        while True:
            print(f'\n{agora()} - EMORP - INTENSIVA E - if __name__ == "__main__" ')
