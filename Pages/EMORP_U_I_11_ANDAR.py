...
st.set_page_config(layout="wide",initial_sidebar_state="collapsed",page_title="EMORP - U.I. 11º ANDAR")
        ...
        with connection:
            ...
            with connection.cursor() as cursor:
                ...
                sql = """ 
                        ...
                        AND APV.CD_SETOR_ATENDIMENTO = 52
...
if __name__ == "__main__":
    try:
        while True:
            print(f'\n{agora()} - EMORP - U.I. 11º ANDAR - if __name__ == "__main__" ')
            ...
            print(f'{agora()} - EMORP - U.I. 11º ANDAR\nst.rerun()\n')
            st.rerun()
