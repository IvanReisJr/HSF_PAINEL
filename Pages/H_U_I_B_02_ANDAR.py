#AND APV.CD_SETOR_ATENDIMENTO = 59
# H - Intensiva B 2º ANDAR
'''
58	H - Intensiva A
59	H - Intensiva B
60	H - Intensiva C
...
st.set_page_config(layout="wide",initial_sidebar_state="collapsed",page_title="H - Intensiva B ")
...
if __name__ == "__main__":
    try:
        while True:
            print(f'\n{agora()} - H - Intensiva B  - if __name__ == "__main__" ')
