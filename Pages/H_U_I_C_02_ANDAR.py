...
st.set_page_config(layout="wide",initial_sidebar_state="collapsed",page_title="H - Intensiva C ")
...
if __name__ == "__main__":
    try:
        while True:
            print(f'\n{agora()} - H - Intensiva C  - if __name__ == "__main__" ')
