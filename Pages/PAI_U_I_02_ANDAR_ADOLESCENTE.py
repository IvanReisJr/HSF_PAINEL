#AND APV.CD_SETOR_ATENDIMENTO = 208
# PAI - U.I 2º ANDAR - ADOLESCENTE 
'''
64   PAI - U.I. 1? ANDAR
65   PAI - U.I. 2? ANDAR
66   PAI - U.I. 3? ANDAR
    ...
    try:
        ...
        with connection:
            ...
            with connection.cursor() as cursor:
                ...
                print("# PAI - U.I 2º ANDAR - ADOLESCENTE")
...
if __name__ == "__main__":
    try:
        while True:
            print(f'\n{agora()} - PAI - U.I 2º ANDAR - ADOLESCENTE  - if __name__ == "__main__" ')
            ...
            st.write("# PAI - U.I 2º ANDAR - ADOLESCENTE")
            ...
            print(f'PAI - U.I 2º ANDAR - ADOLESCENTE \nst.rerun()\n')
            st.rerun()
