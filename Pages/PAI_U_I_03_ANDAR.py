#AND APV.CD_SETOR_ATENDIMENTO = 66
# PAI - U.I. 3º ANDAR
'''
64   PAI - U.I. 1? ANDAR
65   PAI - U.I. 2? ANDAR
...
if __name__ == "__main__":
    try:
        while True:
            print(f'\n{agora()} - PAI - U.I. 3º ANDAR  - if __name__ == "__main__" ')
        ...
        """            
                ...
                MARTINS = df[['MARTINS']].shape[0]
                MARTINS = df[df['MARTINS'] != '-']
                MARTINS = len(MARTINS)
                #print(f'MARTINS: {MARTINS}')
                st.write(f'MARTINS: {MARTINS}')
